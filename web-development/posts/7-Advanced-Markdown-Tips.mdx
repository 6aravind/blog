...
description: Step up your Markdown game with useful and practical tips.

image: https://cdn-images-1.medium.com/max/800/0*2JJAURBs080cgyR2.jpg
...
![Photo by [Suzy
Hazelwood](https://www.pexels.com/photo/black-typewriter-machine-typing-on-white-printer-paper-1303835/)
from Pexels](https://cdn-images-1.medium.com/max/800/0*2JJAURBs080cgyR2.jpg)
...
Don't repeat yourself by typing the URL multiple times in the same Markdown file. 
With the help of reference, we can define the link once and reuse it as many times as required.
